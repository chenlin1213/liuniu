                            ...
                            <Form-Item>
                                <Row>
                                    <i-Col span="13">
                                        ...
                                        <div class="ivu-upload" style="display: inline-block; width: 58px;" @click="openWindows('选择图片','<?php echo Url('widget.images/index',['fodder'=>'image']); ?>',{w:900,h:550})" v-if="!form.image">
                                    ...
                                    <i-Col span="13">
                                        ...
                                        <Tooltip content="请点击查找位置进行选择位置">
                                            <i-Input placeholder="经纬度" v-model="form.latlng" :readonly="true" style="width: 80%" >
                                                <span slot="append" @click="openWindows('查找位置','<?php echo Url('select_address'); ?>',{w:400,h:700})" style="cursor:pointer">查找位置</span>
                                            </i-Input>
                                        </Tooltip>
                                    </i-Col>
                                </Row>
