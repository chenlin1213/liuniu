<?php /*a:1:{s:85:"F:\phpStudy\phpstudy_pro\WWW\projectone.cn\app\admin\view\ump\store_coupon\create.php";i:1613695276;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    <ul class="layui-tab-title">
        <li <?php if($get['type'] == 0): ?>class="layui-this"<?php endif; ?>><a href="<?php echo Url('create',array('tab_id'=>app('request')->param('tab_id'),'type'=>0)); ?>">通用券</a> </li>
        <li <?php if($get['type'] == 1): ?>class="layui-this"<?php endif; ?>><a href="<?php echo Url('create',array('tab_id'=>app('request')->param('tab_id'),'type'=>1)); ?>">品类券</a> </li>
        <li <?php if($get['type'] == 2): ?>class="layui-this"<?php endif; ?>><a href="<?php echo Url('create',array('tab_id'=>app('request')->param('tab_id'),'type'=>2)); ?>">商品券</a></li>
