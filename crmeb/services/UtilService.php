...
class UtilService
{
     ...
     * @throws \Exception
     */
    public static function setShareProductPoster($data = array(), $path = '')
    {
        $config = array(
            'text' => array(
                array(
                    ...
                    'fontPath' => app()->getRootPath() . 'public/static/font/Alibaba-PuHuiTi-Regular.otf',     //字体文件
                    'fontSize' => 50,             //字号
                    'fontColor' => '131,28,32',       //字体颜色
                    'angle' => 0,
                ),
                array(
                    'text' => '原价：￥' . $data['ot_price'],//TODO 原价
                    'left' => 94,
                    'top' => 1105,
                    'fontPath' => app()->getRootPath() . 'public/static/font/Alibaba-PuHuiTi-Light-My.otf',     //字体文件
                    'fontSize' => 18,             //字号
                    'fontColor' => '0,0,0',       //字体颜色
                    'angle' => 0,
                ),
                array(
                    'text' => $data['user_nickname'],//TODO 用户名
                    'left' => 220,
                    'top' => 240,
                    'fontPath' => app()->getRootPath() . 'public/static/font/Alibaba-PuHuiTi-Light.ttf',     //字体文件
                    'fontSize' => 20,             //字号
                    'fontColor' => '0,0,0',       //字体颜色
                    'angle' => 0,
                ),
                array(
                    'text' => implode($data['user_nickname_pinyin'], '  '),//TODO 用户名拼音
                    'left' => 220,
                    'top' => 260,
                    'fontPath' => app()->getRootPath() . 'public/static/font/Alibaba-PuHuiTi-Light.ttf',     //字体文件
                    'fontSize' => 10,             //字号
            ...
            'background' => 'static/poster/product.jpg'
        );
        if (!file_exists($config['background'])) exception('缺少系统预设背景图片');
        if (strlen($data['title']) < 27) {
            $text = array(
                'text' => $data['title'],//TODO 标题
                'left' => 130,
                'top' => 1172,
            ...
            $titleOne = array(
                'text' => mb_substr($data['title'], 0, 8) . '…',//TODO 标题
                'left' => 130,
                'top' => 1172,
                'fontPath' => app()->getRootPath() . 'public/static/font/Alibaba-PuHuiTi-Regular.otf',     //字体文件
                'fontSize' => 22,         //字号
